...
<script type="text/javascript">
	function changeImg(){
		document.getElementById("img1").src="/webcookie/CheckImgServlet?time="+new Date().getTime();
	}
</script>
</head>
<body>
...
<form action="/webcookie/LoginServlet" method="post">
	<table border="1" width="500">
		...
		<tr>
			...
			<img id="img1" src="/webcookie/CheckImgServlet"/>
